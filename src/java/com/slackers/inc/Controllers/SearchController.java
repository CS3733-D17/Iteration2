...
public class SearchController {
    ...
    public void addFilter(ExactFilter_old filter){
        filters.add(filter);

    }

    public void removeFilter(ExactFilter_old filter){
    ...
    public List<Label> runSearch(Label target) throws SQLException {
        ...
        for (ExactFilter_old f : this.filters)
        {
            f.preApply(target);
