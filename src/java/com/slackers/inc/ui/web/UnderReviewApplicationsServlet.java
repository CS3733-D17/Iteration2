 ...
 * @author Jason
 */
@WebServlet(name = "UnderReviewApplicationsServlet", urlPatterns = {"/UnderReviewApplications"})
public class UnderReviewApplicationsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for(int i = 0; i < manufacturer.getApplications().size(); i++){
                if(manufacturer.getApplications().get(i).getStatus() == LabelApplication.ApplicationStatus.UNDER_REVIEW){
