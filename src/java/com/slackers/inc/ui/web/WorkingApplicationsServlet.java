 ...
 * @author Jason
 */
@WebServlet(name = "WorkingApplicationsServlet", urlPatterns = {"/WorkingApplications"})
public class WorkingApplicationsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for(int i = 0; i < manufacturer.getApplications().size(); i++){
                if(manufacturer.getApplications().get(i).getStatus() == LabelApplication.ApplicationStatus.NOT_COMPLETE){
